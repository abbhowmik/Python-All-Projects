...
def run_alexa():
    ...
    if 'play' in command:
        ...
        openpath = 'C:\\Users\\HP\\OneDrive\Desktop\\PYTHON PROGRAMME WITH CODE TOTAL\\All Project Python\\Alexa Aplication\\Alexa_Assistant.py'
        os.startfile(openpath)
